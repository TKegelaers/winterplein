...
| --- | ---------------------------------------------------------------------------- | ---------------------------------------------------- | ------ |
| 1   | [Set Up Solution](docs/changes/project-setup/change.md)                      | Scaffold solution with all projects, MudBlazor, CORS | Done   |
| 2   | [Define Domain Models](docs/changes/domain-models/change.md)                 | Player, Team, Match entities + Shared DTOs           | Done   |
| 3   | [Implement Match Generator](docs/changes/match-generation-service/change.md) | C(N,4)×3 algorithm, unit tests                       | Done   |
| 4   | [Build Player & Match API](docs/changes/player-match-api/change.md)          | Controllers, CQRS, Swagger, integration tests        | Done   |
| 5   | [Build Player UI](docs/changes/player-management-ui/change.md)               | Add/remove players in Blazor WASM                    | Done   |
| 6   | [Build Match Display](docs/changes/match-display-ui/change.md)               | Generate and display all matches                     | Done   |
| 7   | [Polish UI](docs/changes/ui-polish/change.md)                                | Layout, home page, responsive design                 | Done   |
...
| #   | Story                                                                               | Description                                                                    | Status  |
| --- | ----------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ | ------- |
| 1   | [Define Season Domain & DTOs](docs/changes/season-domain-and-dtos/change.md)        | `Season` entity with `GetMatchdays()`, `SeasonDto`, Create/Update request DTOs | Pending |
| 2   | [Implement Season CQRS & Repository](docs/changes/season-cqrs-repository/change.md) | Wolverine commands/queries, `ISeasonRepository`, `InMemorySeasonRepository`    | Pending |
| 3   | [Build Season API](docs/changes/season-api-endpoints/change.md)                     | CRUD + matchdays endpoints, `SeasonMapper`, DI registration                    | Pending |
| 4   | [Build Season UI](docs/changes/season-blazor-ui/change.md)                          | `SeasonApiClient`, list/create/edit/detail pages, `SeasonForm` component       | Pending |
| 5   | [Write Season Tests](docs/changes/season-tests/change.md)                           | Unit tests for domain + handlers, integration tests for API endpoints          | Pending |
...
| #   | Story                                                                         | Description                                                              | Status  |
| --- | ----------------------------------------------------------------------------- | ------------------------------------------------------------------------ | ------- |
| 1   | [View Season Match Pool](docs/changes/season-match-pool/change.md)            | View all possible matches generated from a season's enrolled players     | Pending |
| 2   | [Generate Season Schedule](docs/changes/season-schedule-generation/change.md) | Automatically assign random unique matches to all open matchdays at once | Pending |
| 3   | [Browse & Manage Schedule](docs/changes/season-schedule-management/change.md) | View full matchday schedule, clear individual or all planned matches     | Pending |
...
| #   | Story                                                                              | Description                                                                                | Status  |
| --- | ---------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------ | ------- |
| 1   | [Record Player Absences](docs/changes/player-absence-recording/change.md)          | Mark/unmark players as absent on specific matchdays, with domain, API, and UI              | Pending |
| 2   | [Absence-Aware Schedule Generation](docs/changes/absence-aware-schedule/change.md) | Filter the match pool per matchday to exclude matches with absent players before assigning | Pending |
...
| #   | Story                                                                                                | Description                                                                             | Status |
| --- | ---------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- | ------ |
| 1   | [Replace MediatR with Wolverine Using Shims](docs/changes/wolverine-mediatr-shims/change.md)         | Swap NuGet package, DI, controllers, and using directives via Wolverine's MediatR shims | Done   |
| 2   | [Convert Handlers to Wolverine Native Conventions](docs/changes/wolverine-native-handlers/change.md) | Remove shims, convert to static Handle methods with method injection                    | Done   |
